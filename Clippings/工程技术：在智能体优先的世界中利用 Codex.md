...
## 继续阅读[核心转储流行病学：修复一个存在 18 年的缺陷](https://openai.com/zh-Hans-CN/index/core-dump-epidemiology-data-infrastructure-bug/)

[

工程

](https://openai.com/zh-Hans-CN/index/core-dump-epidemiology-data-infrastructure-bug/)[用 Codex 构建可自我改进的税务智能体](https://openai.com/zh-Hans-CN/index/building-self-improving-tax-agents-with-codex/)

[

工程

](https://openai.com/zh-Hans-CN/index/building-self-improving-tax-agents-with-codex/)[为 Windows 上的 Codex 构建安全高效的沙箱环境](https://openai.com/zh-Hans-CN/index/building-codex-windows-sandbox/)
